...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Element_View__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Store__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Element_Input__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Element_Checkbox_index__ = __webpack_require__(6);
...
class TwoWay {
    ...
    initCheckbox() {
        ...
        for (let i = 0; i < elements.length; i++) {
            const item = elements[i];
            this.views.push(new __WEBPACK_IMPORTED_MODULE_3__Element_Checkbox_index__["a" /* default */](item, this.store));
        }
    }
}
