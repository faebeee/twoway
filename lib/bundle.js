...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Element_Input_Input__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Element_Input_Checkbox__ = __webpack_require__(6);
...
class TwoWay {
    ...
    initInputs() {
        const elements = document.querySelectorAll(`${this.rootElementId} input[data-model]:not([type='checkbox'])`);
        for (let i = 0; i < elements.length; i++) {
            const item = elements[i];
            this.views.push(new __WEBPACK_IMPORTED_MODULE_2__Element_Input_Input__["a" /* default */](item, this.store));
        }
    }
    initCheckbox() {
        ...
        for (let i = 0; i < elements.length; i++) {
            const item = elements[i];
            this.views.push(new __WEBPACK_IMPORTED_MODULE_3__Element_Input_Checkbox__["a" /* default */](item, this.store));
        }
    }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AbstractInput__ = __webpack_require__(4);
