...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Element_Input_Select_index__ = __webpack_require__(8);
...
class TwoWay {
    ...
    init() {
        ...
        this.initInput(`${this.rootElementId} select[data-model]`, __WEBPACK_IMPORTED_MODULE_4__Element_Input_Select_index__["a" /* default */]);
